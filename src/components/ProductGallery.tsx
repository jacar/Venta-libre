  ...
  return (
    <div className="flex flex-col gap-4 w-full max-w-md">
      ...
      <div className="w-full aspect-square bg-white border border-gray-200 rounded-lg overflow-hidden flex items-center justify-center relative group">
        <Image 
          src={mainImage || "https://admin.ventalibre.top/wp-content/uploads/woocommerce-placeholder.png"} 
          alt={productName} 
          fill
          priority
        ...
        <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide snap-x">
          {images.map((img, idx) => (
            <button
              ...
              className={`relative flex-shrink-0 w-16 h-16 sm:w-20 sm:h-20 border-2 rounded-md overflow-hidden bg-white snap-center transition-colors ${
                mainImage === img.src ? "border-[#e52e04]" : "border-gray-200 hover:border-[#fb7701]"
              }`}
            >
              <Image 
                src={img.src || "https://admin.ventalibre.top/wp-content/uploads/woocommerce-placeholder.png"} 
