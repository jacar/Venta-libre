...
export default function Navbar() {
  ...
  return (
    <>
      {/* Top micro-bar (Temu style) */}
      <div className="bg-[#f5f5f5] border-b border-gray-200 text-gray-500 text-[11px] py-1.5 px-4 flex justify-between items-center">
        <div className="flex items-center gap-4 max-w-7xl mx-auto w-full">
          ...
          <span className="flex items-center gap-1 hover:text-[#fb7701] cursor-pointer"><MapPin className="w-3 h-3"/> Enviar a Colombia</span>
        </div>
      </div>

      <nav className="bg-white border-b border-gray-200 sticky top-0 z-30">
        <div className="max-w-[1400px] mx-auto px-4 py-3 flex flex-wrap lg:flex-nowrap justify-between items-center gap-4">
                    ...
                    {searchResults.map((product) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <span className="text-xs font-bold text-[#e52e04]">${product.price || "0"}</span>
                        </div>
                      </Link>
                    ))}
                  </div>
          ...
          {/* Icons: Account, Returns, Cart */}
          <div className="order-2 lg:order-3 flex items-center gap-6 z-50">
